...
const defaultTableData: PendingCategoryData[] = [
  { category: 'IT Equipment', invCount: 7, avgAge: '3.5 days', status: 'Notified', statusType: 'notify' },
  { category: 'Utilities', invCount: 1, avgAge: '3.5 days', status: 'In AP Review', statusType: 'review' },
];
  ...
  return (
    <div style={{ marginBottom: "2rem", marginTop: "1rem" }}>
      ...
      <div style={{ 
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1.8fr", gap: "16px", width: "100%" }}>
                        ...
                        <tbody>
                            {tableData.map((row, idx) => (
                                <tr key={idx} style={{ 
                                    ...
                                    <td style={{ padding: "10px 14px", color: "var(--text-primary)" }}>{row.invCount}</td>
                                    <td style={{ padding: "10px 14px", color: "var(--text-primary)" }}>{row.avgAge}</td>
